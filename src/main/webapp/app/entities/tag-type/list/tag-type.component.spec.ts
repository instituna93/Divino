...
describe('TagType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'tag-type', component: TagTypeComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tagTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to tagTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTagTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTagTypeIdentifier).toHaveBeenCalledWith(entity);
