...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.instituna.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.instituna.security.DomainUserDetailsService", "createSpringSecurityUser");
